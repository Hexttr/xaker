      ...
      <div className="p-4 md:p-6">
        <div className="max-w-7xl mx-auto">
          <div className="mb-6">
            ...
            <p className="text-sm text-gray-500">Анализ пентестов по сервисам</p>
          </div>
          ...
          <div className="bg-gray-900 rounded p-4 mb-6 border border-gray-700">
            ...
            <select
              ...
              className="w-full px-3 py-1.5 text-sm bg-gray-800 border border-gray-700 text-white rounded focus:ring-1 focus:ring-red-500 focus:border-red-500"
          ...
          {selectedServiceId && (
            <>
              ...
              {pentestsLoading ? (
                ...
                <div className="bg-gray-900 rounded p-6 mb-6 border border-gray-700">
