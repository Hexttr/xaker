...
Ты эксперт по кибербезопасности и пентестингу. Проанализируй все предоставленные файлы с результатами пентеста и создай ПОЛНЫЙ ПОДРОБНЫЙ ОТЧЕТ ПО РЕЗУЛЬТАТАМ ПЕНТЕСТА для сервиса ${targetUrl}.
...
- ГЕНЕРИРУЙ МАКСИМАЛЬНО ДЛИННЫЙ И ПОДРОБНЫЙ ОТЧЕТ - НЕ ЭКОНОМЬ НА СЛОВАХ!
- Минимум 10000-15000 слов в отчете (не менее 50000-80000 символов)
- Включай критические, высокие и средние уязвимости
- Каждое описание должно быть ПОДРОБНЫМ - минимум 5-10 предложений на каждую уязвимость
...
- РАСШИРЯЙ КАЖДЫЙ РАЗДЕЛ - добавляй детали, примеры, объяснения
- НЕ БОЙСЯ БЫТЬ МНОГОСЛОВНЫМ - ЧЕМ БОЛЬШЕ ДЕТАЛЕЙ, ТЕМ ЛУЧШЕ!`;
...
Ты эксперт по кибербезопасности. На основе анализа файлов результатов пентеста создай ПОДРОБНУЮ ЦЕПОЧКУ ВЗЛОМА (attack chain) для сервиса ${targetUrl}.
...
Создай подробную пошаговую цепочку взлома на русском языке.`;
...
Ты эксперт по кибербезопасности. На основе анализа файлов результатов пентеста создай ПОДРОБНЫЙ детальный анализ (без ограничений по размеру, только на русском языке) для сервиса ${targetUrl}.

ВАЖНО:
- ВСЕ ТЕКСТЫ ДОЛЖНЫ БЫТЬ НА РУССКОМ ЯЗЫКЕ!
- ГЕНЕРИРУЙ МАКСИМАЛЬНО ДЛИННЫЙ И ПОДРОБНЫЙ АНАЛИЗ - НЕ ЭКОНОМЬ НА СЛОВАХ!
- Минимум 2000-3000 слов в анализе (не менее 10000-15000 символов)
- НЕ копируй фрагменты файлов, код или команды
...
Создай максимально подробный и длинный структурированный анализ на русском языке. НЕ ЭКОНОМЬ НА СЛОВАХ!`;
