...
5. ОТЧЕТ ДОЛЖЕН СОДЕРЖАТЬ ВСЕ 6 РАЗДЕЛОВ, УКАЗАННЫХ НИЖЕ - НЕ ТОЛЬКО ЦЕПОЧКУ ВЗЛОМА!
6. ОТЧЕТ ДОЛЖЕН БЫТЬ КРАТКИМ НА 10-15 ЛИСТОВ (НЕ БОЛЕЕ 3000 СЛОВ, НЕ БОЛЕЕ 15000 СИМВОЛОВ)
7. НИ В КОЕМ СЛУЧАЕ НЕ копируй фрагменты файлов, команды, код или длинные тексты из файлов в итоговый отчет
8. Анализируй файлы, но описывай результаты СВОИМИ СЛОВАМИ, КРАТКО (2-3 предложения)
9. Включай только КРИТИЧЕСКИЕ и ВЫСОКИЕ уязвимости (средние и низкие ПРОПУСКАЙ)
10. Каждое описание - МАКСИМУМ 2-3 предложения, не больше
11. НЕ дублируй информацию между разделами
12. Убирай ВСЕ лишние детали, технические подробности, коды, команды - оставляй только СУТЬ
13. Если отчет получается больше 15000 символов - ОБРЕЖЬ его до этого размера
