...
- ✅ Минимум 10000-15000 слов (50000-80000 символов)
- ✅ Не копировать фрагменты файлов, команды, код
- ✅ Описывать результаты своими словами
- ✅ Включать критические, высокие и средние уязвимости
- ✅ Каждое описание - минимум 3-5 предложений
...
#### 2. ТРЕБОВАНИЯ К СОДЕРЖАНИЮ
- ✅ Максимально длинный и подробный анализ
- ✅ Минимум 2000-3000 слов (10000-15000 символов)
- ✅ Не копировать фрагменты файлов, код или команды
- ✅ Подробно описать ВСЕ ключевые моменты
...
- ✅ Расширять каждый раздел - добавлять детали, примеры, объяснения
- ✅ Не бояться быть многословным
...
#### 2. ТРЕБОВАНИЯ К СОДЕРЖАНИЮ
- ✅ Подробная пошаговая цепочка взлома
...
- ✅ Каждый шаг описать подробно - минимум 3-5 предложений
- ✅ Минимум 5-7 шагов в цепочке взлома
...
|----------|---------------|------------------|----------------|
| **max_tokens** | 64000 | 32000 | 32000 |
| **Размер контента** | 200000 символов | 200000 символов | 100000 символов |
| **Минимальный размер ответа** | 50000-80000 символов | 10000-15000 символов | Не указан |
